 ...
 */
import { create as api_game_create_room_create } from "~backend/game/create_room";
import { stream as api_game_game_stream_stream } from "~backend/game/game_stream";
import { join as api_game_join_room_join } from "~backend/game/join_room";
...
export namespace game {
    ...
    export class ServiceClient {
         ...
         */
        public async create(): Promise<ResponseType<typeof api_game_create_room_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/game/create`, {method: "POST", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_game_create_room_create>
        }

        /**
         * Validates that a room exists before joining.
         */
        public async join(params: RequestType<typeof api_game_join_room_join>): Promise<ResponseType<typeof api_game_join_room_join>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/game/join`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_game_join_room_join>
        }

        public async stream(params: RequestType<typeof api_game_game_stream_stream>): Promise<StreamInOut<StreamRequest<typeof api_game_game_stream_stream>, StreamResponse<typeof api_game_game_stream_stream>>> {
            ...
            return await this.baseClient.createStreamInOut(`/game/stream`, {query})
        }
    }
}

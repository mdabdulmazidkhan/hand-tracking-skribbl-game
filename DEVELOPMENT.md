...
```bash
git remote add encore encore://hand-tracking-skribbl-game-pqz2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hand-tracking-skribbl-game-pqz2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hand-tracking-skribbl-game-pqz2/settings/integrations/github)
